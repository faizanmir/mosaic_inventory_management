...
class ItemDetailsRepo  with AuthTokenMixin  implements ItemDetailsApi{
  ...
  @override
  Future<ItemResponse> deleteItem(int categoryId, int itemId, {String? authToken})async  {
    return _itemDetailsApi.deleteItem(categoryId, itemId,authToken: await mGetAccessToken());
  }

  @override
  Future<ItemResponse> updateItem(int itemCategoryId, int id, Item item, {String? authToken}) async{
    return _itemDetailsApi.updateItem(itemCategoryId, id, item,authToken: await mGetAccessToken());
  }

  @override
  Future<ItemResponse> addFilesToItem(int itemId,XFile file,{String? authToken}) async{
    return _itemDetailsApi.addFilesToItem(itemId, file,authToken:await mGetAccessToken());
  }

  @override
  Future<ItemResponse> deleteFileFromItem(int itemId, int fileId, {String? authToken}) async {
    return _itemDetailsApi.deleteFileFromItem(itemId, fileId,authToken: await mGetAccessToken());
  }

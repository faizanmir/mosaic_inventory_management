...
class ChooseImageBottomSheet extends StatelessWidget {
  ...
  ChooseImageBottomSheet({Key? key, required this.fileNavigator}) : super(key: key);
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: const [
                    ...
                    Text("Click picture",style: TextStyle(fontSize: 15),)
                  ],
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: const [
                    Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Icon(Icons.phone_iphone_sharp,size: 30,),
                    ),
